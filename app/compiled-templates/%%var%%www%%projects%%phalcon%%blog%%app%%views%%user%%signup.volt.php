...
<body>
	...
	<?php echo $this->tag->form(array('user/signup', 'method' => 'post')); ?>

	<div class="form-group">
		<label for="email">E-mail</label>
		<?php echo $this->tag->emailField(array('email', 'maxlength' => '100', 'class' => 'form-control')); ?>
	</div>
	<div class="form-group">
		<label for="username">Username</label>
		<?php echo $this->tag->textField(array('username', 'maxlength' => '15', 'class' => 'form-control')); ?>
	</div>
	<div class="form-group">
		<label for="password">Password</label>
		<?php echo $this->tag->passwordField(array('password', 'class' => 'form-control')); ?>
	</div>
	<?php echo $this->tag->submitButton(array('Signup', 'class' => 'btn btn-default')); ?>
